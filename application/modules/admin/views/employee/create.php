                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="marital" placeholder="Nhập tình trạng hôn nhân" required name="marital">
                            <?= form_error('marital','<p class="text-danger">','</p>');?>
                        </div>
                        <div class="form-group">
                            <label for="date">Ngày tạo</label>
                            <input type="text" class="form-control" id="date" placeholder="YYYY-MM-DD" required name="date">
                            <?= form_error('date','<p class="text-danger">','</p>');?>
                        </div>
                        <div>
                            <input type="radio" name="gender" value="1"><label>Nam</label>
                            <input type="radio" name="gender" value="0"><label>Nữ</label>
                        </div>
